...
function FileMenu() {
  ...
  useEffect(() => {
    ...
    if (menuState === true) {
      currentMenu
        ...
        .css(
          "top",
          currentMenu.height() + menuPosition.y + 10 >
            document.body.offsetHeight
            ? document.body.offsetHeight - currentMenu.height() - 10
            : menuPosition.y
        );
  ...
  return (
    <div
      className="fm-contextmenu fixed animate__animated animate__zoomIn animate__faster"
      ref={ref}
    >
